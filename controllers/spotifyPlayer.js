...
async function addTracks(playlist_id, track_uris){
    try {
        ...
        logger.error(`Spotify API: Adding tracks to playlist failed. ${JSON.stringify(error)}`, error);
        throw Error(error);
    }
}
...
async function getAllPlaylists(){
    try {
        ...
        logger.error(`Spotify API: Get all playlists failed. ${JSON.stringify(error)}`, error);
        throw Error(error);
    }
}
...
async function getDevices(){
    try {
        ...
        logger.error(`Spotify API: Get devices failed. ${JSON.stringify(error)}`, error);
        throw Error(error);
    }
}
...
async function getPlaybackState(){
    try {
        ...
        logger.error(`Spotify API: Get playback state failed. ${JSON.stringify(error)}`, error);
        throw Error(error);
    }
}
...
async function getPlayingTrack(){
    try{
        ...
        logger.error(`Spotify API: Get current playing track failed. ${JSON.stringify(error)}`, error);
        throw Error(error);
    }
}
...
async function getPlaylist(playlist_id){
    try {
        ...
        logger.error(`Spotify API: Get playlist failed. ${JSON.stringify(error)}`, error);
        throw Error(error);
    }
}
...
async function getPlaylistTracks(playlist_id, offset){
    try{
        ...
        logger.error(`Spotify API: Get playlist tracks failed. ${JSON.stringify(error)}`, error);
        throw Error(error);
    }
}
...
async function getSearchTracks(query){
    try {
        ...
        logger.error(`Spotify API: Get Search Tracks failed. ${JSON.stringify(error)}`, error);
        throw Error(error);
    }
...
async function getArtists(query){
    try {
        ...
        logger.error(`Spotify API: Get Artists failed. ${JSON.stringify(error)}`, error);
    }
}
...
async function getTrack(track_id){
    try {
        ...
        logger.error(`Spotify API: Get track failed. ${JSON.stringify(error)}`, error);
        throw Error(error);
    }
}
...
async function pause(){
    try {
        ...
        logger.error(`Spotify API: Pause failed. ${JSON.stringify(error)}`, error);
    }
}
...
async function play(){
    try {
        ...
        logger.error(`Spotify API: Play failed. ${JSON.stringify(error)}`, error);
        throw Error(error);
    }
}
...
async function playWithContext(playlist_id, offset, position_ms){
    try {
        ...
        logger.error(`Spotify API: Play with context failed ${JSON.stringify(error)}`, error);
        throw Error(error);
    }
}
...
async function reset(playlist_id){
    try {
        ...
        logger.error(`Spotify API: Reset failed. ${JSON.stringify(error)}`, error);
        throw Error(error);
    }
}
...
async function skip(){
    try {
        ...
        logger.error(`Spotify API: Skip failed. ${JSON.stringify(error)}`, error);
        throw Error(error);
    }
}
